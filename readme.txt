...
= 1.9.0 =
* 3rd party libraries updated to the latest versions.
* Added compatibility with PHP v7.2+
* Changed password encryption to OpenSSL (you'll need to re-enter your SMTP/IMAP passwords in WPNewsman Settings).

= 1.8.21 =
* Fixed Bulk unsubscribe option on PHP 7.1+

= 1.8.20 =
* Fixed path to install dir
...
= 1.8.15 =
* Fixed templates store not working on SSL websites

= 1.8.14 =
* Fixed bug which prevented to properly form Google or Piwik analytics links
...
= 1.8.18 =
* You need to upgrade if you plan to switch to PHP >= 7.0.0
